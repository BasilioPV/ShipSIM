  ...
  package Validations "Examples used to validate the models"
    ...
    equation
      ...
      annotation(
        ...
        Documentation(info = "<html><head></head><body>This example provides a face to face comparison fron two ways of model the propeller: Kt and Kq Vs Ct and Cq (1Q Vs 4Q)<br></body></html>", revisions = "<html><head></head><body><span style=\"font-size: 12px;\">Rev. 0.0&nbsp;</span><span style=\"font-size: 12px;\">[BPuente]</span><span style=\"font-size: 12px;\">&nbsp;(01/12/2024): Initial release</span></body></html>"),
    ...
    equation
      ...
      annotation(
        ...
        Diagram,
        Documentation(info = "<html><head></head><body><div>Validation of a plate dynamic heat transfer.</div>Example 16.10 of the book:<div><br></div><div><table border=\"0\" cellspacing=\"0\" cellpadding=\"2\" style=\"font-family: 'MS Shell Dlg 2';\"><tbody><tr><td>[ThSysEng]</td><td>Michael J. Moran, Howard N. Shapiro, Bruce R. Munson, David P. DeWitt, \"Introduction to Thermal Systems Engineering\", John Wiley &amp; Sons, Inc., 1st Edition, 2003</td></tr></tbody></table></div><div><br><div><br></div></div></body></html>", revisions = "<html><head></head><body><span style=\"font-size: 12px;\">Rev. 0.0&nbsp;</span><span style=\"font-size: 12px;\">[BPuente]</span><span style=\"font-size: 12px;\">&nbsp;(01/12/2023): Initial release</span></body></html>"));
    ...
    equation
      ...
      annotation(
        ...
        Diagram,
        Documentation(info = "<html><head></head><body>Validation of the results for a transient heat transfer in a cylinder.<div>Example 4.3 of the book:</div><div><table border=\"0\" cellspacing=\"0\" cellpadding=\"2\" style=\"font-family: 'MS Shell Dlg 2';\"><tbody><tr><td>[Chapman]</td><td>Alan J. Chapman, \"Heat Transfer\", McMillan Publishing Company, 4th Edition, 1984</td></tr></tbody></table></div><div><br><div><br></div></div></body></html>", revisions = "<html><head></head><body><span style=\"font-size: 12px;\">Rev. 0.0&nbsp;</span><span style=\"font-size: 12px;\">[BPuente]</span><span style=\"font-size: 12px;\">&nbsp;(01/12/2023): Initial release</span></body></html>"));
